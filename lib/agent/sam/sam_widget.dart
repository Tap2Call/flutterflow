...
class _SamWidgetState extends State<SamWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SamModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'I exist to help you schedule your appointments based on your past medical history!',
                          textAlign: TextAlign.start,
                          style:
