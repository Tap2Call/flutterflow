...
import 'noa_model.dart';
export 'noa_model.dart';

class NoaWidget extends StatefulWidget {
  const NoaWidget({super.key});

  @override
  State<NoaWidget> createState() => _NoaWidgetState();
}

class _NoaWidgetState extends State<NoaWidget> {
  late NoaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoaModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'I exist to help you negotiate your claims based on your past medical history!',
                          textAlign: TextAlign.start,
                          style:
